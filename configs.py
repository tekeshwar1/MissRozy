...
STREAM_LOGS = environ.get('STREAM_LOGS','-1002128918840')
SESSION = environ.get('SESSION','MissRozy')
CUSTOM_CAPTION = environ.get('CUSTOM_CAPTION')


class Config(object):
	API_ID = int(os.environ.get("API_ID", 23943856))
	API_HASH = os.environ.get("API_HASH", "5e9d007637c71b25f3099795f4dc5f30")
	BOT_TOKEN = os.environ.get("BOT_TOKEN","6369071500:AAEfHFMoiuWT0jOaTV6BDT19eU8UysHj4_4")
